...
.data 
    ...
    A       dw ?
    B       dw ?
    msg1    dw 'Give the value of A and B ... $' 
    result  dw 0
    flag    dw 0 
    endl    dw 10, 13, 10, 13, 'The Result of A = B - A is ....... $'
    base    dw 10
    counter dw 0
...
while_end2: 
         ...
         mov ax, result ;here result(B) values copy into ax register
         sub ax, A      ;ax = ax - A means ax = B - A
         mov A, ax ;bcz beginning of Diplay16bitsNumber ah get 09h 
